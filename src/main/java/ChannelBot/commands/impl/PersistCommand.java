...
public class PersistCommand implements Command {
	...
	public void execute(final CommandContext context) {
		...
		try {
			DataPersistenceService.persist(context.getChannelBot());
			channelBot.qtell(context.getUsername(), ChannelBot.getUsername() + ": Data has been saved.");
		} catch (Exception e) {
			channelBot.qtell(context.getUsername(), ChannelBot.getUsername() + ": Unable to save data due to an exception.");
