 ...
 */
package ChannelBot.commands.resolver.impl;

import ChannelBot.PatternService;
import ChannelBot.StringUtils;
import ChannelBot.commands.Command;
import ChannelBot.commands.impl.*;
import ChannelBot.commands.resolver.CommandResolver;

import java.util.regex.Matcher;
import java.util.regex.Pattern;

public class LegacyCommandResolver implements CommandResolver {
	public Command resolveCommand(final String commandName) {
		final PatternService patternService = PatternService.getInstance();
		Pattern pattern;
		Matcher matcher;
